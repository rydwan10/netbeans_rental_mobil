 ...
 */
public class form_laporan_karyawan extends javax.swing.JFrame {

    /**
     * Creates new form form_laporan_karyawan
     */
    public form_laporan_karyawan() {
        initComponents();
        new laporan_method.method_laporan_karyawan().tampil_data(this);
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/team(1).png"))); // NOI18N
    ...
    private void jbcetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbcetakActionPerformed
       new laporan_method.method_laporan_karyawan().cetak(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_laporan_karyawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_laporan_karyawan().setVisible(true);
            }
        });
    }
