 ...
 */
public class form_laporan_mobil extends javax.swing.JFrame {

    /**
     * Creates new form form_laporan_mobil
     */
    public form_laporan_mobil() {
        initComponents();
        new laporan_method.method_laporan_mobil().tampil_data(this);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Laporan Data Mobil");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/carbtn_128.png"))); // NOI18N
    ...
    private void jbcetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbcetakActionPerformed
        new laporan_method.method_laporan_mobil().cetak(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_laporan_mobil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_laporan_mobil().setVisible(true);
            }
        });
    }
